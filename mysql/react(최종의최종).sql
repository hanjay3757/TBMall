...
insert into tbmall_comment (board_no, member_no , comment_content , comment_writedate) values(1,1,'도배금지',sysdate());
...
alter table tbmall_board rename COLUMN board_writdate TO board_writedate;
...
select * from tbmall_board ;
insert into tbmall_board ( member_no , board_title, board_content,board_readcount,board_writdate ) values(1,1,1,1,sysdate());
