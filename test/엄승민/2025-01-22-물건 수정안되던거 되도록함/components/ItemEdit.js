...
function ItemEdit() {
  ...
  useEffect(() => {
    const loadItem = async () => {
      try {
        ...
        const currentItem = items.find((item) => String(item.item_id) === String(itemId));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Login check:', loginResponse.data);
      ...
      console.log('Submitting item edit with params:', Object.fromEntries(params));
      ...
      console.error('Error during item edit:', error);
